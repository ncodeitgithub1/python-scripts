...
def bear_room():
    ...
    while True:
        ...
        if next == "take honey":
            ...
            print "the bear ha smoved from the door. you can go through it now."
            bear_moved = True
        elif next == "taunt bear" and bear_moved:
            dead("the bear get pissed off and chews your legg off.")
            gold_room()
        else:
...
def cthulhu_room():
    ...
    print "Do you flee to your life or eat you head?"
    next = raw_input("> ")
    if "flee" in next:
        start()
    elif "head" in next:
